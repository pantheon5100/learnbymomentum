...
class TinyImageNet(BaseDataset):
    def ds_train(self):
        ...
        return ImageFolder(root=self.dataset_dir+"/tiny-imagenet-200/train", transform=t)
    ...
    def ds_test(self):
        t = base_transform()
        return ImageFolder(root=self.dataset_dir+"/tiny-imagenet-200/test", transform=t)
